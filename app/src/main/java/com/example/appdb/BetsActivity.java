...
public class BetsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBaseHelper = new DataBaseHelper(BetsActivity.this);
        ...
        btn_propose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(BetsActivity.this, userModel.toString(), Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(BetsActivity.this, "Wrong input", Toast.LENGTH_SHORT).show();
                    userModel = new UserModel(-1, "error", 0, false);

                }

                DataBaseHelper dataBaseHelper = new DataBaseHelper(BetsActivity.this);
